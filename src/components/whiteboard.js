        ...
        <>
            <Container>
                ...
                <PencilWidthContainer>
                    ...
                    <SquareButtonPencil id="xs" className="commonColor">2px</SquareButtonPencil>
                    <SquareButtonPencil id="small" className="commonColor">5px</SquareButtonPencil>
                    <SquareButtonPencil id="medium" className="commonColor">10px</SquareButtonPencil>
                    <SquareButtonPencil id="large" className="commonColor">15px</SquareButtonPencil>
                    <SquareButtonPencil id="xl" className="commonColor">20px</SquareButtonPencil>
                </PencilWidthContainer>
